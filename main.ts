...
// Allows proxying requests to any URL through your Deno Deploy instance
// Usage: https://your-app.deno.dev/https://example.com
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    responseHeaders.set('X-Proxied-By', 'Deno-Serverless-Proxy');
